...
def update_category_global_metrics():
    """
    Calcula las métricas para la tabla 'category_global_metrics' utilizando ÚNICAMENTE
    ...
    try:
        ...
        # --- PASO 2: Insertar/Actualizar tabla 'category_global_metrics' ---
        print("\nPaso 2: Actualizando tabla 'category_global_metrics'...")
        
        upsert_query = """
            INSERT INTO category_global_metrics 
...
if __name__ == '__main__':
    update_category_global_metrics()
